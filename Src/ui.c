...
unsigned char enemyType1[] = { 0x00, 0x0E, 0x0E, 0x1F, 0x04, 0x04, 0x0E, 0x0A };

unsigned char enemyType2[] = { 0x0A, 0x0E, 0x0E, 0x04, 0x0E, 0x15, 0x0E, 0x0A };

unsigned char enemyType3[] = { 0x0C, 0x1C, 0x04, 0x1F, 0x04, 0x1F, 0x15, 0x15 };

unsigned char enemyType4[] = { 0x0C, 0x0C, 0x08, 0x0E, 0x0F, 0x0F, 0x0E, 0x0A };

unsigned char plantType1[] = { 0x15, 0x15, 0x0E, 0x04, 0x15, 0x1F, 0x0E, 0x04 };

unsigned char plantType2[] = { 0x00, 0x0A, 0x11, 0x15, 0x0E, 0x0E, 0x0E, 0x0E };

unsigned char plantType3[] = { 0x00, 0x0E, 0x0E, 0x1F, 0x1F, 0x1F, 0x1F, 0x0E };

unsigned char coins[] = { 0x00, 0x0E, 0x1F, 0x1B, 0x1F, 0x0E, 0x00, 0x00 };

unsigned char midstone[] = { 0x00, 0x00, 0x00, 0x00, 0x1F, 0x1F, 0x1F, 0x00 };
...
void showZombieCharactor(int i, char actorf1) {
	if (actorOfTheGame.PvZzombies[i].isDead == 0
			&& actorOfTheGame.PvZzombies[i].isInitial == 1)
		putch(actorOfTheGame.PvZzombies[i].place.posx,
				actorOfTheGame.PvZzombies[i].place.posy, actorf1);
	else if (actorOfTheGame.PvZzombies[i].isDead == 1
			&& actorOfTheGame.PvZzombies[i].isInitial == 1)
		putch(actorOfTheGame.PvZzombies[i].place.posx,
...
void screen_normal_game() {
	...
	clearLCD();
	//FIXME: in chera constante ? Dast nakon bache
	...
	for (int i = 0; i < exist_plant; i++) {
		if (actorOfTheGame.PvZPlants[i].type == Rose)
			putch(actorOfTheGame.PvZPlants[i].place.posx,
					actorOfTheGame.PvZPlants[i].place.posy, plant_Type1);
		else if (actorOfTheGame.PvZPlants[i].type == Venus)
			putch(actorOfTheGame.PvZPlants[i].place.posx,
					actorOfTheGame.PvZPlants[i].place.posy, plant_Type2);
		else if (actorOfTheGame.PvZPlants[i].type == Potato)
			putch(actorOfTheGame.PvZPlants[i].place.posx,
					actorOfTheGame.PvZPlants[i].place.posy, plant_Type3);
...
void ui_screen_ready_play() {
	clearLCD();
	if (frame == 0) {
		createChar(0, midstone);
		createChar(1, midstoneUpper);
	}
